...
def setup_sidebar() -> tuple[str, str]:
    ...
    selected_model_real_name = model_options[selected_model_name]
    ...
    return selected_model_real_name, google_api_key
...
def handle_user_prompt(prompt: str) -> None:
    ...
    chat_session = st.session_state.chat_session # type: ignore # Ensuring chat_session is not None
